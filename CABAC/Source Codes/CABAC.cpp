...
char *memblock;  // to store data from file
int n;           // store context value
int preprocess;  // store decision about preprocessing
...
void printFileSize(int n, char inputFilename[], char outputFilename[], int encodedFileSize, int originalFileSize, int preprocess){
	...
	cout << "Compression Ratio    : " << (float)originalFileSize/encodedFileSize*100 << "%" << endl;
	cout << "---------------------------------" << endl;
}
